...
class Search extends SearchDelegate<String> {
  ...
  ThemeData appBarTheme(BuildContext context) {
    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        headline6: TextStyle(
            color: isDark ? Colors.white : Colors.black, fontFamily: 'Manrope'),
      ),
      textSelectionTheme: TextSelectionThemeData(
        cursorColor: const Color(0xFF7D3C98),
  ...
  Widget buildLeading(BuildContext context) {
    return IconButton(
      icon: const Icon(Icons.arrow_back, color: Color(0xFF7D3C98)),
      onPressed: () {
        close(context, '');
      },
    );
      ...
      child: Scaffold(
        body: Container(
          ...
          child: Column(
            children: [
              TabBar(
                indicatorColor: const Color(0xFF7D3C98),
                tabs: [
                  Tab(
                    child: Text('Movies',
                        style: TextStyle(
